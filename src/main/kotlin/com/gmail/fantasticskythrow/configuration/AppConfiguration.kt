...
class AppConfiguration(yamlConfiguration: YamlConfiguration) : IAdvancedGeneratorAppConfiguration, IAppConfiguration {
    ...
    override val advancedStatusEnabled = yamlConfiguration.getBoolean("advancedMessages.enabled")
    override val useRandom = yamlConfiguration.getBoolean("advancedMessages.useRandom")
